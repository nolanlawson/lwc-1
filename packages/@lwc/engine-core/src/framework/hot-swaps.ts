...
// The important thing here is the weak values – VMs are transient and should be GC'ed.
// The weak keys are kind of useless, because Templates, LightningElementConstructors, and StylesheetFactories are
// never GC'ed. But maybe they will be someday, so we may as well use weak keys as well.
