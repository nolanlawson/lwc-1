...
function trackMutations(tmpl: Template) {
    ...
    defineProperty(tmpl, 'stylesheetTokens', {
        ...
        set(value) {
            reportViolation('stylesheetTokens');
