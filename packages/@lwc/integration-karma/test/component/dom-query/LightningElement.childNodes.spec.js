...
describe('LightningElement.childNodes', () => {
    it('should throw when invoked in the constructor', () => {
        expect(() => {
            ...
            /\[LWC error]: this.childNodes should not be called during the construction of the custom element for <x-constructor-child-nodes> because the element is not yet in the DOM or has no children yet\./
        );
    });
