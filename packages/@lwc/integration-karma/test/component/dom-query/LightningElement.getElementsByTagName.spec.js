...
describe('LightningElement.getElementsByTagName', () => {
    it('should throw when invoked in the constructor', () => {
        expect(() => {
            ...
            /\[LWC error]: this.getElementsByTagName\(\) should not be called during the construction of the custom element for <x-constructor-get-elements-by-tag-name> because the element is not yet in the DOM or has no children yet\./
        );
    });
});
