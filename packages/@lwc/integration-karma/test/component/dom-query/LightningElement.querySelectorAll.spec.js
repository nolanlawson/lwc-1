...
describe('LightningElement.querySelectorAll', () => {
    it('should throw when invoked in the constructor', () => {
        expect(() => {
            ...
            /\[LWC error]: this.querySelectorAll\(\) should not be called during the construction of the custom element for <x-constructor-query-selector-all> because the element is not yet in the DOM or has no children yet\./
        );
    });
