...
if (supportCallingGetBoundingClientRect) {
    it('should throw when accessing during construction', () => {
        expect(() => {
            ...
            /\[LWC error]: this\.getBoundingClientRect\(\) should not be called during the construction of the custom element for <x-constructor-invocation> because the element is not yet in the DOM or has no children yet\./
        );
    });
}
