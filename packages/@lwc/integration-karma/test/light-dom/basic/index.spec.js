...
describe('Basic Light DOM', () => {
    ...
    it('should return null for template', () => {
        ...
        expect(() => {
            ...
            '[LWC error]: `this.template` returns null for light DOM components. Since there is no shadow, the rendered content can be accessed via `this` itself. e.g. instead of `this.template.querySelector`, use `this.querySelector`.'
        );
