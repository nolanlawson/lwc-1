...
describe('feature flags', () => {
    describe('setting a flag', () => {
        ...
        it('warns on setting non-boolean flag', () => {
            expect(() => {
                setFeatureFlagForTest('DUMMY_TEST_FLAG', 'not a boolean');
            }).toLogErrorDev(
                /Incorrect value "not a boolean" for the runtime feature flag "DUMMY_TEST_FLAG"\. Runtime feature flags should be set to a boolean value\./
            );
        });
    });

    describe('setFeatureFlagForTest', () => {
        let packages;
