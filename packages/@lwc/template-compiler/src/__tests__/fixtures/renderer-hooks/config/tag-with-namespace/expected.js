...
const $fragment1 = parseFragment`<span${3}>Should not get custom renderer!<circle cx="5" cy="5" r="4" stroke="blue"${3}></circle><use href="#myCircle" x="10" fill="blue"${3}></use></span>`;
const stc0 = {
  classMap: {
    "slds-icon": true,
  },
