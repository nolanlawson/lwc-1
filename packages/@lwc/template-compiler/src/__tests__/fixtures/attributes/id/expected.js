...
const $fragment1 = parseFragment`<label${3}>label text</label>`;
const $fragment2 = parseFragment`<input${3}>`;
const $fragment3 = parseFragment`<input${3}>`;
const $fragment4 = parseFragment`<p${3}>description text</p>`;
const $fragment5 = parseFragment`<input${3}>`;
