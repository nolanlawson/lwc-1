...
const ignoredProperties = ['constructor', 'length']
...
module.exports = {
  ...
  "overrides": [
    ...
    {
      // For server-side code, we don't need to use language.ts from @lwc/shared because
      // the perf improvement from minification is not really worth it. So we only target client-side
      // packages (and only those that can actually import @lwc/shared)
      "files": [
